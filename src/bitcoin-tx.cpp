...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s syncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  syncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded syncoin transaction") + "\n" +
              "  syncoin-tx [options] -create [commands]   " + _("Create hex-encoded syncoin transaction") + "\n" +
              "\n";
