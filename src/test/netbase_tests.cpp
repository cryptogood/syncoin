...
BOOST_AUTO_TEST_CASE(netbase_networks)
{
    ...
    BOOST_CHECK(CreateInternal("174.138.51.144").GetNetwork()                           == NET_INTERNAL);
...
BOOST_AUTO_TEST_CASE(netbase_properties)
{
    ...
    BOOST_CHECK(CreateInternal("174.138.51.144").IsInternal());
...
{
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1:29335", -1));
...
{
    BOOST_CHECK(TestParse("127.0.0.1", "127.0.0.1:29335"));
