...
const char * const BITCOIN_CONF_FILENAME = "syncoin.conf";
const char * const BITCOIN_PID_FILENAME = "syncoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Syncoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Syncoin";
#else
    // Unix
    return pathRet / ".syncoin";
#endif
#endif
}
